...
import { Gamepad2, LogIn, User, Eye, EyeOff, AlertCircle, ArrowLeft } from 'lucide-react';
      ...
      <div className="relative z-10 flex min-h-[calc(100vh-88px)] items-center justify-center px-4 pb-12">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center space-y-4">
            ...
            <div>
              <h1 className="text-3xl font-semibold text-slate-100">Oyna.gg'e Hoş Geldiniz</h1>
              <p className="text-sm text-slate-400">Topluluğunuza giriş yapın ve yayıncıları takip edin</p>
            </div>
          </div>
          ...
          <Card className="overflow-hidden border border-slate-800/60 bg-slate-900/70 shadow-2xl shadow-black/40">
            ...
            <CardHeader className="relative pb-4 text-center">
              ...
              <CardDescription className="text-slate-400">
                Oyna.gg hesabınıza e-posta ve şifrenizle giriş yapın
              </CardDescription>
            </CardHeader>
